...
export default function TermsAndConditions(/* props */) {
  return (
    <div className="terms-of-service-container">
      ...
      <h2>OVERVIEW</h2>
      <p>
        This website is operated by All Pawn. Throughout the site,
        the terms “we”, “us” and “our” refer to All Pawn.
        All Pawn offers this website, including all information,
      ...
      <p>
        ...
        users who are browsers, vendors, customers, merchants, and/
        or contributors of content.
      </p>
      <p>
        Please read these Terms of Service carefully before accessing
        or using our website. By accessing or using any part of the site,
      ...
      <p>
        ...
        attempt to notify you by contacting the e-mail and/or billing address
        /phone number provided at the time the order was made. We reserve
      ...
      material, or contain any computer virus or other malware that could
        in any way affect the operation of the Service or any related website
      ...
      <p>
        These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of 25907 Interstate 45, Spring, TX, 77380, United States.
      </p>
      ...
      <p>
        Questions about the Terms of Service should be sent to us at allpawn.ebay@gmail.com.
      </p>
      <h1>RETURNS</h1>
      <p>
      ...
      <p>
        ...
        If you’ve done all of this and you still have not received your refund yet, please contact us at allpawn.ebay@gmail.com.
      </p>
      ...
      <p>
        We only replace items if they are defective or damaged.  If you need to exchange it for the same item, send us an email at allpawn.ebay@gmail.com and send your item to: 25907 Interstate 45, Spring, TX, 77380, United States.
      </p>
      <h3>Gifts</h3>
      <p>
      ...
      <h3>Shipping</h3>
      <p>
        To return your product, you should mail your product to: 25907 Interstate 45, Spring, TX, 77380, United States.
      </p>
      <p>
